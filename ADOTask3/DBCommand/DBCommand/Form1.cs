...
namespace DBCommand
{
    public partial class Form1 : Form
    {
        ...
        private void buttonGetData_Click(object sender, EventArgs e)
        {
            ...
            reader.Close();
            sqlCommand1.Connection.Close(); //или sqlConnection1.Close();
            ResultsTextBox.Text = results.ToString();
        }

        private void buttonRunProc_Click(object sender, EventArgs e)
        {
            System.Text.StringBuilder results = new System.Text.StringBuilder();
            ...
            reader.Close();
            sqlCommand2.Connection.Close(); //или sqlConnection1.Close();
            ResultsTextBox.Text = results.ToString();
        }
