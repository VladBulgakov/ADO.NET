...
namespace LINQsqlSproc
{
    public partial class Form1 : Form
    {
        ...
        //С этой строчкой работает:
        //Northwind db = new Northwind(@"Integrated Security=SSPI; Persist Security Info=False; Initial Catalog=Northwind; Data Source=DESKTOP-E6LKVU6\SQLEXPRESS");
